...
contexts_list, target_list, negative_sampling_list = contextsTargetBuilder.get_train_contexts_target(train_data)
print()
print('triplet')
for i in range(len(contexts_list)):
    print(contexts_list[i], target_list[i], negative_sampling_list[i])
# print('contexts_list', contexts_list)
# print('target_list', target_list)
# print('negative_sampling_list', negative_sampling_list)
# print('validate data')
