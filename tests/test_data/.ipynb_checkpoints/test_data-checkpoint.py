def get_method_map():
    method_map = [
        ...
        # },
        {
            'item': 'cli/DBHandler#public_void_storeRepositoryReaderResult(RepositoryReaderResult_result,String_dbName)',
            'index': 4
        },
        {
            'item': 'scm/MappedList#public_void_setReplaced(T_oldItem,T_newItem)',
            'index': 3
        },
        {
            'item': 'scm/Commit#public_Commit(RevCommit_revCommit)',
            'index': 2
        },
        {
            'item': 'LCExtractor#public_LCExtractor()',
            'index': 1
        },
        {
            'item': 'coupling/Predictor#public_RepositoryReaderResult_getData()',
            'index': 0
        }
    ]
    return method_map
